...
info = """\033[34m
╔══════════════════════════════════════════════════════╗
║                     \033[34mDOKI Shit\033[34m                       ║
║══════════════════════════════════════════════════════║
║ \033[35m[~] DOKI Was Made By Ceill ~~ ENJOY!\033[35m                ║
║ \033[35m[~] Discord: lol no.\033[35m                             ║
║ \033[35m[~] Instagram: ceillowned.\033[35m                                ║
║ \033[35m[~] YouTube: CeillBoi.\033[35m                                  ║
╚══════════════════════════════════════════════════════╝\033[34m
"""
...
def main():
	...
	while True:
		sys.stdout.write("\x1b]2;DOKI ~~ Made By Ceill\x07")
		...
		if sinput == "clear":
			...
			print ("[\033[35mSkid\033[35m] You Are Exiting Out Of Doki.\n")                                                                        
			print ("                                  Made By Ceill                        		")
...
try:
	...
	if user == "DOKI":
		if password == passwords[0]:
			...
			print ("\033[34m[+] Type Help To See Commands for DOKI ;).")
			titties = """
...
"""
			...
			print ("\033[34m[+] Skid Shit Granted.")
			print ("\033[34m[+] Type Help To See Commands for Ceill ;).")
			print (" 									")
			print (" 									")
			print (" 									")
			print (" 									")
			print ("\033[35m                    ╔═════════════════════════════════════╗\033[35m")
			print ("\033[35m                    ║               \033[0;34mDOKI INFO\033[0;34m            \033[35m║\033[35m")
			print ("\033[35m                    ║═════════════════════════════════════║\033[35m")
...
#SKID THIS SHIT AND ILL KILL YOUR FAMILY, Love Ceill <3..